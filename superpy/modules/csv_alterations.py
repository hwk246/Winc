...
from modules.set_date_and_time import get_current_date, increment, get_advance_time
...
def add_to_csv(a,b,c,d='empty',e='empty'):
    ...
    # initial check if current date is used and not the advance_time date
    ...
    if advance_timer == 0: 
        ...
        create_window([sg.Text(f'reset the advance_time by   {advance_timer*-1}   before selling or buying any product', size=(50,2), justification='center')])    
